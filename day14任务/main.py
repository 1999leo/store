...
# 1.加载所有用例
tests = unittest.defaultTestLoader.discover(r"D:\PycharmProjects\pythonProject\day14\day14任务", pattern="test*.py")
...
runner = HTMLTestRunner.HTMLTestRunner(
    ...
    verbosity=1,
    # 写入文件
    stream=open("工行系统测试.html", mode="w+", encoding="utf-8")
)
...
msg['From'] = formataddr(["夏云鹏", sender])  # 括号里对应发件人邮箱昵称、发件人邮箱账号
...
att = MIMEText(open(r'工行系统测试.html', 'rb').read(), 'base64', 'utf-8')
